 ...
 * @author harshita
 */
@WebServlet(urlPatterns = {"/Updatebankdetails"})
public class Updatebankdetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest req, HttpServletResponse res)
        ...
        String bank=req.getParameter("bn");
		...
		Statement stm=cn.createStatement();
                out.println(acname);
                int x=stm.executeUpdate("update bankdetails set  account_name='"+acname+"',bank_name='"+bank+"',ifsc_code='"+ifsc+"' where account_number='"+acn+"'");
           if(x>0)
           {
               out.println("Updated");
           }
