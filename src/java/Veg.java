...
"                              <h1 align=\"center\" ><font color=\"red\">Veg Top Dishes</font></h1></td></tr>\n" +
"            </table>");
                    ...
                    if(sh.equals("1")&&ct.equals("veg"))
                {
                    ...
                    out.println("<td><a href=Order?x="+id+" style=text-decoration:none>order now</a> </td>");
		...
		if(sh.equals("1")&&ct.equals("veg"))
                {
                    ...
                    out.println("<td ><input type=text value='"+pr+"'  disabled=true></td>");
                    out.println("<td><a href=Order style=text-decoration:none>order now</a> </td>");
                    out.println("</tr></table>");
                    out.println("</body></html>");
                }
                }
